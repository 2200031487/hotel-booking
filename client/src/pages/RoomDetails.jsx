        ...
        mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    className='w-full rounded border-gray-300 px-3 py-2 mt-1.5
                ...
                <div className='flex flex-col'>
                    ...
                    className='max-w-20 rounded border border-gray-300
            ...
            <button 
  type="submit" 
  className="bg-sky-500 hover:bg-sky-600 active:scale-95 transition-all 
             text-white rounded-md max-md:w-full max-md:mt-6 
             md:px-6 py-3 md:py-4 text-base cursor-pointer">
  Check Availability
</button>
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability. You get a comfortable
            Two bedroom apartment has a true city feeling. The price quoted is for two guest, at the
            guest slot please mark the number of guests to get the extract price for groups. The Guests
            will be allocated ground floor according to availability. You get the comfortable two bedroom
    ...
    <div className='flex flex-col items-start gap-4'>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-while bg-primary
        hover:big-primary-dull transition-all cursor-pointer'>Contact Now</button>
    </div>
    </div>
  )
}
